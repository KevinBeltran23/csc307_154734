...
function Settings(props) {
    ...
    function toggleCheck(settingId) {
        const settingToUpdate = props.settings.find(
        ...
        if (!settingToUpdate) {
            ...
            props
                .postSetting(updatedSetting)
                .then((newItemResponseJson) => {
                    props.setSettings((prevSetting) => [
                        ...prevSetting,
                        newItemResponseJson
                    ]);
                    ...
                    <div>
                        <label className="settings-label">
                            ...
                            <select
                                ...
                                onChange={(event) =>
                                    handleDropdownChange("language", event)
                                }
                            >
                    ...
                    <div>
                        <label className="settings-label">
                            ...
                            <select
                                ...
                                onChange={(event) =>
                                    handleDropdownChange("default_view", event)
                                }
                            >
        ...
        return (
            <div>
                <label className="settings-label">
                    ...
                    <select
                        value={
                            Object.keys(settings["Language & Region"]).find(
                                (key) => settings["Language & Region"][key]
                            ) || "English"
                        }
                        onChange={(event) =>
                            handleDropdownChange("Language & Region", event)
                        }
                    >
            ...
            <div>
                <label className="settings-label">
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            handleDropdownChange("Calendar Settings", event)
                        }
                    >
                        <option value="Monthly">Monthly</option>
                        <option value="Weekly">Weekly</option>
